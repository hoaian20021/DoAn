        ...
        <div id="ant-layout">
            ...
            <section class="main">
                <div class="row">
                    ...
                    <p>Tại Codedoan, chúng tôi hiểu rằng một bữa ăn ngon có thể mang lại cho bạn sức khoẻ và tinh thần
                        thoải mái nhất.</p>
                </div>
                <div class="row">
                    <h3>Codedoan Coffee hoạt động như thế nào?</h3>
                    <p>Codedoan Coffee hoạt động từ 7h đến 22h hằng ngày, tuỳ theo khu vực của bạn và thời gian mở cửa
                        cụ thể.</p>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <p>Chi phí hiển thị trên ứng dụng bao gồm chi phí của phần ăn theo đơn giá của quán và phí vận
                        chuyển.</p>
                </div>
